...
class IEnvironment():
    ...
    def adjustVersion(self, dockerfile):
        """Provides ability to customize docker build based on the 'Version'
        parameter provided in the config. Useful in environment types with many very
        similar versions, e.g. Drupal ones.

        The default implementation simply does nothing.

        Args:
          dock (boolean): If method should produce a verbose output.
        """
        pass
